...
def main():
    ...
    default_prompt = "Assume I am blind. describe what you see in front of you. Be as detailed as you can. If the image does not look upright, please rotate it until it is and analyze it that way. If the image is blurry, give instructions how to fix it."
    ...
    while(not restart):
        ...
        if time_pressed <= 1.6 and time_pressed >= 0.1: # Image Description Using Default Prompt
            ...
            if button_pressed == 2:   # Image with Custom Prompt
                ...
                temp_prompt = context_window + f"Current Question: Assume I am blind... {transcript}. If the image does not look upright, please rotate it and analyze it as such. If the image is blurry, give instructions how to fix it. \n"
